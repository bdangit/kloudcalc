 ...
 * Customized: Ben D 7/2012 - turned into a function to call
 */

(function( $ ){
  $.fn.convert2dropdown = function(i) {
    e = this;
    if (!($(e).data('convert') == 'no')) {
      //get some initial data...
      xSelect = $(e).attr('id')
      xLabel =  $(e).children("option:selected").text()
      xClass =  $(e).data('class');
                
      $(e).hide().wrap('<div class="btn-group" id="select-group-' + i + '" />');
      
      var select = $(e).parent(); // '#select-group-' + i);
